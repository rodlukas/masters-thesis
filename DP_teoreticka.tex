...
Shrnutí implementovaných funkčních požadavků \cite{bp}:
\begin{itemize}
...
Následuje shrnutí implementovaných nefunkčních požadavků \cite{bp}:
\begin{itemize}
...
\subsection{Srovnání s dynamickým typováním}
