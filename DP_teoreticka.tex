...
\begin{figure}[hb]\centering
	...
	\caption[Srovnání \enquote{testovací pyramidy} a \enquote{zmrzlinového kornoutu}]{Srovnání \enquote{testovací pyramidy} (vlevo) a \enquote{zmrzlinového kornoutu} (vpravo) \cite{test-fishman}}\label{fig:testing_pyramid}
\end{figure}
