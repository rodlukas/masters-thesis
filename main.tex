...
\usepackage{rotating} % otaceni obrazku s caption
...
\keywordsEN{web application, Úspěšný prvňáček, Successful first-grader, Python, Django, React, Django REST framework}
